...
{
  const { COMMANDS, COSTS_MONEY, dailyCommands, gateCommands, helpLine, usageWidth } =
  ...
  assert.ok(Object.keys(table).length >= 25,
    `배분표를 ${Object.keys(table).length}개밖에 못 읽었다 — SUBCOMMANDS 모양이 바뀌었나`);
